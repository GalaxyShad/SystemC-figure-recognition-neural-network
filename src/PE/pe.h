...
public:
    // �����
    sc_core::sc_in<bool> compute_mode_i;  // 0 - ����� ������ ����� ����� ������ �� ��������� ������
                                          // 1 - ����� ���������� �������

    sc_core::sc_in<bool> clk_i;                  // ������������
    sc_core::sc_in<bool> rst_i;                  // �����

    sc_core::sc_in<u32>  output_neuron_index_i;  // ������ ������������ ��������� �������
    sc_core::sc_in<u32>  data_weights_in_i;      // ���� ������ �����
    sc_core::sc_in<u32>  data_neurons_i;         // ���� ������ ��������

    // ������
    sc_core::sc_out<bool> is_computation_end_o;   // ���� ���������� � ������
    sc_core::sc_out<u32>  result_neuron_o;        // ����������� ������
